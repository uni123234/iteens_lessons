...
class CategoryDb(DefaultInterface):
    ...
    def create_category(self, **kwargs):
        name_of_columns, insert_times, columns, values = get_write_data(**kwargs)
...
# noinspection SqlNoDataSourceInspection,SqlDialectInspection,PyProtectedMember
class SpendingsDb(DefaultInterface):
    ...
    def create_spending(self, amount, category_id, date=None, is_spending=False):
        category_name = g._category_db.get_category(category_id)['name']
        name_of_columns, insert_times, columns, values = get_write_data(
